...
import { selectCartItems, selectCartState, selectTotalAmount, selectTotalQTY, setClearItemQTY, setCloseCart, setGetTotal } from '../app/CartSlice'
...
const Cart = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 right-0 bottom-0 blur-effect-theme w-full h-screen opacity-100 z-[250] ${ifCartState ? 'opacity-100 visible translate-x-0' : 'opacity-0 invisible translate-x-8'}`}>
      <div className='blur-effect-theme h-screen lg:w-[40%] absolute right-0'>
        ...
        <div>
          <div className='flex items-start justify-start flex-col gap-y-5 lg:gap-y-7 overflow-y-scroll h-[80vh] scroll-smooth scroll-hidden pt-3 pb-16'>
          ...
          <div className='fixed bottom-0 bg-white w-full px-5 py-2 grid items-center'>
            ...
            <div className='grid items-center gap-2'>
              <p className='text-sm font-medium text-center'>Taxes and Shipping Will be Calculated At Shipping port </p>
